...
acl purge {
    # Not sure how to consistently have the right IP address here...
    # Sometimes it is 172.29.0.4, or 172.29.0.5... We commentout out
    # somes lines near "if (!client.ip ~ purge)".
    "172.29.0.5";
}
...
sub vcl_recv {
    ...
    if (req.method == "BAN") {
        ...
        return (synth(200, "Ban added. " + "obj.http.purge-cache-tags ~ " + req.http.purge-cache-tags));
    }
