...
echo ''
echo '-----'
echo 'About to create the purge_demo_default network if it does'
...
docker network ls | grep purge_demo_default || docker network create purge_demo_default
...
echo ''
echo '-----'
echo 'Removing cache on the dummy client.'
rm -rf ./client/username
